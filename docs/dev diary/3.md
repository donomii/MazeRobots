...
I need to get pathfinding working quickly.  A jobs system is mostly useless without having a way for the robots to walk around the map normally.  Previously, the robots would just walk in a straight line to their target, ignoring everything in their way.  Now they respect walls, and will walk around obstacles on their way to their destination.
